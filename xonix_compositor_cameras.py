...
Не включена:
- tuya_sp — 404 через echo-прокси HA, нестабильна на момент реализации.
...
CAMERAS = [
    ...
    ("xm530", (640, 360), [
        FF, "-nostdin", "-loglevel", "warning", "-vaapi_device", "/dev/dri/renderD128",
        "-rtsp_transport", "tcp", "-i", "rtsp://127.0.0.1:8554/xm530_cam",   # 2026-09-15: чистый поток (xm530 теперь с оверлеем)
